...
class _CountDownPageState extends State<CountDownPage> {
  ...
  void _startTimer() {
    if(min == 0 && sec == 0) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => TimerPage("", "countdown", min*60+sec, [], ModelBlock("", 0, "", 0, 0, false, "", "", [], true, 0, 0, [], false, "", [], [], [], ""))));
    }
  }
        ...
        child: Column(
          children: <Widget>[
            Container (
              ...
              child: TitleLabelBack("Count Down"),
            ),
